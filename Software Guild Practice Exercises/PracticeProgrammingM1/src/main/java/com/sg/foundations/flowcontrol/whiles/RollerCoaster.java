...
//this while won't ever run because keepRiding is set to y.
        /*while (keepRiding.equals("n")) {
            System.out.println("Alright, we're stopping!");
            System.out.print("Want to keep going? (y/n) :");
            keepRiding = userInput.nextLine();
            loopsLooped++;
        }
...
//if the user doesnt type y or n the below will print by default.
