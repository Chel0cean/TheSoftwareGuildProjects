...
public class DvdCollectionView {
    ...
    public Dvd getNewDvdInfo() {
        ...
        LocalDate releaseDate = io.readLocalDate("Please enter the Dvd's release date (YYYY-MM-DD)");
    ...
    public LocalDate promptReleaseDateUpdate() {
        LocalDate update = io.readLocalDate("Please enter the Dvd's release date: (YYYY-MM-DD)");
        return update;
    }
